...
def get_data():   
    ...
    # os.mkdir(img_dir)
    csv_file = open('F:\\xdl\\github\\crawler-demo\\url\\data\\zkh_cate.csv','w',encoding='utf-8')
    csv_over1000_file = open('F:\\xdl\\github\\crawler-demo\\url\\data\\zkh_cate_over1000.csv','w',encoding='utf-8')
